...
public class dairyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setOrientation(dairyActivity.this);
        TextView cart =findViewById(R.id.textView15);
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent setupIntent = new Intent(dairyActivity.this, CheckoutActivity.class);
    ...
    private void loaddata(String pincodex, String shopid) {
        ...
        firestore.collection(pincodex+shopid+"diary").addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
    ...
    private void firebaseSearch(String searchText,String pincodex, String shopid) {
        ...
        FirebaseFirestore firestore = FirebaseFirestore.getInstance();
        firestore.collection(pincodex+shopid+"diary").orderBy("itemname").startAt(query).endAt(query +"\uf8ff").limit(5).addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
    ...
    private void setOrientation(dairyActivity context) {
