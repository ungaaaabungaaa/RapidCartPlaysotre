...
public class personalActivity extends AppCompatActivity {
    ...
    private PersonalRecyclerAdapter notificationsAdapterx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setOrientation(personalActivity.this);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent setupIntent = new Intent(personalActivity.this, CheckoutActivity.class);
    ...
    private void loaddata(String pincodex, String shopid) {
        ...
        notificationsAdapterx = new PersonalRecyclerAdapter(NotifListx);
        ...
        firestore.collection(pincodex+shopid+"personalcare").addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
    ...
    private void firebaseSearch(String searchText,String pincodex, String shopid) {
        ...
        FirebaseFirestore firestore = FirebaseFirestore.getInstance();
        firestore.collection(pincodex+shopid+"personalcare").orderBy("itemname").startAt(query).endAt(query +"\uf8ff").limit(5).addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
    ...
    private void setOrientation(personalActivity context) {
