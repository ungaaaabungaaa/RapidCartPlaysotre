...
public class FruitsCart extends AppCompatActivity {
    TextView desc;
    TextView pricex;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruits_cart);
        ImageView back=findViewById(R.id.imageView19);
        Carteasy cs = new Carteasy();
        x = "del";
        setOrientation(FruitsCart.this);
        ...
        firebaseFirestore.collection("Users").document(user_id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>()
        {
                ...
                if(task.isSuccessful()){
                    if(task.getResult().exists()){
                        ...
                        if (bundle2 != null) {
                            ...
                            Glide.with(FruitsCart.this).load(itemimage).thumbnail(0.25f).into(imageView);
                        }
                        ...
                        cartaddbutton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (value1.equals(""))
                                {
                                    ...
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 1", Toast.LENGTH_LONG).show();
                                    finish();
                                } else if (value2.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 2", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                else if (value3.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 3", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value4.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 4", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value5.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 5", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value6.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 6", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value7.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 7", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value8.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 8", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value9.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 9", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value10.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 10", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                else if (value11.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 11", Toast.LENGTH_LONG).show();
                                    finish();
                                } else if (value12.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 12", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                else if (value13.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 13", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value14.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 14", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value15.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 15", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value16.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 16", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value17.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 17", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value18.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 18", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value19.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 19", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value20.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 20", Toast.LENGTH_LONG).show();
                                    finish();
                                } else if (value21.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 21", Toast.LENGTH_LONG).show();
                                    finish();
                                } else if (value22.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 22", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                else if (value23.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 23", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value24.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 24", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value25.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 25", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value26.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 26", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value27.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 27", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value28.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 28", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value29.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 29", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value30.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 30", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                (value31.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 31", Toast.LENGTH_LONG).show();
                                    finish();
                                } else if (value32.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 32", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                else if (value33.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 33", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value34.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 34", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                else if (value35.equals(""))
                                {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(FruitsCart.this, true);
                                    Toast.makeText(FruitsCart.this, itemname+"Added to cart 35", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                                ...
                                {
                                    Toast.makeText(FruitsCart.this, "Max item in cart ", Toast.LENGTH_LONG).show();
                                    finish();
                                }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(FruitsCart.this, e.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void setOrientation(FruitsCart context) {
