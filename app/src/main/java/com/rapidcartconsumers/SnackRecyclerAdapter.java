...
public class SnackRecyclerAdapter  extends RecyclerView.Adapter<SnackRecyclerAdapter.ViewHolder> {
    ...
    public SnackRecyclerAdapter(List<MainModel> notifList) {
    ...
    @NonNull
    @Override
    public SnackRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mainitemx, parent, false);
        context = parent.getContext();
        return new SnackRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SnackRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent Intent = new Intent(context, SnackCart.class);
