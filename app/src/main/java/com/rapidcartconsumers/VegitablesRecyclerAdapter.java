...
public class VegitablesRecyclerAdapter  extends RecyclerView.Adapter<VegitablesRecyclerAdapter.ViewHolder> {
    public List<MainModel> mainList;
    public Context context;

    public VegitablesRecyclerAdapter(List<MainModel> notifList) {
        this.mainList=notifList;
    }

    @NonNull
    @Override
    public VegitablesRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mainitemx, parent, false);
        context = parent.getContext();
        return new VegitablesRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VegitablesRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent Intent = new Intent(context, Vegitablescart.class);
