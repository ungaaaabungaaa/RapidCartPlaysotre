...
public class SnacksActivity extends AppCompatActivity {
    ...
    private SnackRecyclerAdapter notificationsAdapterx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setOrientation(SnacksActivity.this);
        searchView=findViewById(R.id.search_field);
        TextView cart =findViewById(R.id.textView15);
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent setupIntent = new Intent(SnacksActivity.this, CheckoutActivity.class);
    ...
    private void loaddata(String pincodex, String shopid) {
        ...
        notificationsAdapterx = new SnackRecyclerAdapter(NotifListx);
        ...
        firestore.collection(pincodex+shopid+"snacks").addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
    ...
    private void firebaseSearch(String searchText,String pincodex, String shopid) {
        ...
        FirebaseFirestore firestore = FirebaseFirestore.getInstance();
        firestore.collection(pincodex+shopid+"snacks").orderBy("itemname").startAt(query).endAt(query +"\uf8ff").limit(5).addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
    ...
    private void setOrientation(SnacksActivity context) {
