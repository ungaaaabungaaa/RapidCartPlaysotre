...
public class Dairycart extends AppCompatActivity {
    TextView desc;
    TextView pricex;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dairycart);
        ImageView back = findViewById(R.id.imageView19);
        Carteasy cs = new Carteasy();
        setOrientation(Dairycart.this);
        x = "del";
        ...
        firebaseFirestore.collection("Users").document(user_id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        if (bundle2 != null) {
                            ...
                            Glide.with(Dairycart.this).load(itemimage).thumbnail(0.25f).into(imageView);
                        }
                        ...
                        cartaddbutton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (value1.equals("")) {
                                    ...
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 1", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 2", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 3", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 4", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 5", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 6", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 7", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 8", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 9", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 10", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 11", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 12", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 13", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 14", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 15", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 16", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 17", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 18", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 19", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 20", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 21", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 22", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 23", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 24", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 25", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 26", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 27", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 28", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 29", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 30", Toast.LENGTH_LONG).show();
                                    finish();
                                } else if
                                (value31.equals("")) {
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 31", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 32", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 33", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 34", Toast.LENGTH_LONG).show();
                                    finish();
                                    ...
                                    cs.commit(getApplicationContext());
                                    cs.persistData(Dairycart.this, true);
                                    Toast.makeText(Dairycart.this, itemname + "Added to cart 35", Toast.LENGTH_LONG).show();
                                    finish();
                                } else {
                                    Toast.makeText(Dairycart.this, "Max item in cart ", Toast.LENGTH_LONG).show();
                                    finish();
                                }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Dairycart.this, e.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void setOrientation(Dairycart context) {
