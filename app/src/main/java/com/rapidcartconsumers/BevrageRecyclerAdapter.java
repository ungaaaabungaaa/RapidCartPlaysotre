...
public class BevrageRecyclerAdapter extends RecyclerView.Adapter<BevrageRecyclerAdapter.ViewHolder> {

    public List<MainModel> mainList;
    public Context context;

    public BevrageRecyclerAdapter(List<MainModel> notifList) {
    ...
    @NonNull
    @Override
    public BevrageRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mainitemx, parent, false);
        context = parent.getContext();
        return new BevrageRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BevrageRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent Intent = new Intent(context, BevrageCart.class);
