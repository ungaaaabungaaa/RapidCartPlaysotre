...
public class DryFruitsRecyclerAdapter extends RecyclerView.Adapter<DryFruitsRecyclerAdapter.ViewHolder>{

    public List<MainModel> mainList;
    public Context context;

    public DryFruitsRecyclerAdapter(List<MainModel> notifList)
    {
    ...
    @NonNull
    @Override
    public DryFruitsRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mainitemx, parent, false);
        context = parent.getContext();
        return new DryFruitsRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DryFruitsRecyclerAdapter.ViewHolder holder, int position)
    {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent Intent = new Intent(context, DryFruitsCart.class);
