...
public class PersonalRecyclerAdapter  extends RecyclerView.Adapter<PersonalRecyclerAdapter.ViewHolder> {
    ...
    public PersonalRecyclerAdapter(List<MainModel> notifList) {
        this.mainList=notifList;
    }

    @NonNull
    @Override
    public PersonalRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mainitemx, parent, false);
        context = parent.getContext();
        return new PersonalRecyclerAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull PersonalRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent Intent = new Intent(context, PersonalCart.class);
