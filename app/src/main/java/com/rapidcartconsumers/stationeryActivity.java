...
public class stationeryActivity extends AppCompatActivity {
    ...
    private StationeryRecyclerAdapter notificationsAdapterx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setOrientation(stationeryActivity.this);
        searchView = findViewById(R.id.search_field);
        TextView cart =findViewById(R.id.textView15);
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent setupIntent = new Intent(stationeryActivity.this, CheckoutActivity.class);
    ...
    private void loaddata(String pincodex, String shopid) {
        ...
        notificationsAdapterx = new StationeryRecyclerAdapter(NotifListx);
        ...
        firestore.collection(pincodex+shopid+"stationery").addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
    ...
    private void firebaseSearch(String searchText,String pincodex, String shopid) {
        ...
        FirebaseFirestore firestore = FirebaseFirestore.getInstance();
        firestore.collection(pincodex+shopid+"stationery").orderBy("itemname").startAt(query).endAt(query +"\uf8ff").limit(5).addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
    ...
    private void setOrientation(stationeryActivity context) {
