...
public class FruitsRecyclerAdapter extends RecyclerView.Adapter<FruitsRecyclerAdapter.ViewHolder> {

    public List<MainModel> mainList;
    public Context context;

    public FruitsRecyclerAdapter(List<MainModel> notifList) {
        this.mainList=notifList;
    }

    @NonNull
    @Override
    public FruitsRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mainitemx, parent, false);
        context = parent.getContext();
        return new FruitsRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FruitsRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent Intent = new Intent(context, FruitsCart.class);
