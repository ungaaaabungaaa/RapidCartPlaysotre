...
public class SummartActivity extends AppCompatActivity {
    ...
    TextView ordertype;
    String deliverytype;
    ConstraintLayout mainlayout,splashlayout;
    Button showorders;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summart);
        setOrientation(SummartActivity.this);
        ...
        showorders=findViewById(R.id.checkyourorder);
        showorders.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent setupIntent = new Intent(SummartActivity.this, OdersAcitivity.class);
                        ...
                        placeorderbutton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (pincodex != null && phonenumberx != null && namex != null && addressx != null) {
                                    ...
                                    userMap.put("uniqueid",randonString);
                                    // need to make updates in the adapter
                                    firebaseFirestore.collection(storeid1 + "orders").add(userMap).addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(SummartActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                        ...
                                        public void onComplete(@NonNull Task<DocumentReference> task) {
                                            firebaseFirestore.collection(user_id + "orders").add(userMap).addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onComplete(@NonNull Task<DocumentReference> task) {
                                                    ...
                                                    cs.clearCart(SummartActivity.this);

                                                    //send sms and push notification here
                                                    // to merchant app
    ...
    private void setOrientation(SummartActivity context) {
